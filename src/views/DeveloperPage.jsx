...
import Logo from "assets/img/angel.png";
...
gallery</Link> page.</h3>
                            <a href="https://github.com/syne612?tab=repositories"><img src={Logo} alt="..." className={classes.imgLogoSry} /></a>
                            <h4>Sorry we don't have the projects avalible to view at this time but click the logo to go to my github, and view the projects there.</h4>
...
export default withStyles(profilePageStyle)(DeveloperPage);
